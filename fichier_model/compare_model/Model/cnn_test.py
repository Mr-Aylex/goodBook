...
def model(vocabulary, dropout_rate=0.15, kernel_regularizer=regularizers.L1L2(l1=1e-5, l2=1e-4),bias_regularizer=regularizers.L2(1e-4),activity_regularizer=regularizers.L2(1e-5)):
    ...
    conv1 = keras.layers.Conv1D(64, 6, activation=keras.activations.relu,
    ...
    conv1 = keras.layers.Conv1D(128, 6, activation=keras.activations.relu,
                                kernel_regularizer=kernel_regularizer,
                                bias_regularizer=bias_regularizer,
    ...
    conv1 = keras.layers.Conv1D(256, 6, activation=keras.activations.relu,
                                kernel_regularizer=kernel_regularizer,
                                bias_regularizer=bias_regularizer,
                                activity_regularizer=activity_regularizer)(conv1)
    conv1 = keras.layers.Dropout(dropout_rate)(conv1)
    ...
    return keras.Model(inputs=[inputs1, inputs2, inputs3, inputs4, inputs5, inputs6, inputs7], outputs=output, name="cnn_test")
